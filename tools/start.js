...
async function start() {
          ...
          function checkForUpdate(fromUpdate) {
                    ...
                    if (!app.hot) {
                              throw new Error(
                                        `${hmrPrefix}Hot Module Replacement is disabled.`,
                              );
                    }
                    ...
                    return app.hot
                              ...
                              .then(updatedModules => {
                                        ...
                                        if (updatedModules.length === 0) {
                                                  console.info(
                                                            `${hmrPrefix}Nothing hot updated.`,
                                                  );
                                        } else {
                                                  console.info(
                                                            `${hmrPrefix}Updated modules:`,
                                                  );
                              ...
                              .catch(error => {
                                        if (
                                                  ...
                                                  app = require('../build/server')
                                                            .default;
                                                  console.warn(
                                                            `${hmrPrefix}App has been reloaded.`,
                                                  );
                                        } else {
                                                  console.warn(
