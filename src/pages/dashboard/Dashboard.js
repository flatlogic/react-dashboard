          ...
          <Col sm={6}>
            {this.state.alert1Visible &&
              <Alert
                className="alert-sm"
                bsStyle="warning"
                onDismiss={() => this.setState({ alert1Visible: false })}
              >
            ...
            {this.state.alert2Visible &&
              <Alert
                className="alert-sm"
                bsStyle="success"
                onDismiss={() => this.setState({ alert2Visible: false })}
              >
            ...
            {this.state.alert3Visible &&
              <Alert
                className="alert-sm"
                bsStyle="info"
                onDismiss={() => this.setState({ alert3Visible: false })}
              >
            ...
            {this.state.alert4Visible &&
              <Alert
                ...
                bsStyle="danger"
                onDismiss={() => this.setState({ alert4Visible: false })}
              >
